...
const createCombatTell = () => {
  ...
  element.style.cssText =
    'position:absolute;z-index:5;transform:translate(-50%,-100%);padding:3px 6px;border:1px solid #777566;background:#f4efd9;color:#292b25;font:700 13px/18px ui-monospace,monospace;pointer-events:none;white-space:nowrap';
